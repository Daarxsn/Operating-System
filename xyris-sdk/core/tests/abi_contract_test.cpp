...
static_assert(XYRIS_SYS_GETPID == 5u, "GETPID syscall number changed");
static_assert(XYRIS_SYS_MEMORY_MAP == 10u, "MEMORY_MAP syscall number changed");
static_assert(XYRIS_SYS_IPC_CREATE == 13u, "IPC_CREATE syscall number changed");
static_assert(XYRIS_SYS_EVENT_CREATE == 17u, "EVENT_CREATE syscall number changed");
static_assert(XYRIS_SYS_TIMER_CREATE == 21u, "TIMER_CREATE syscall number changed");
static_assert(XYRIS_SYS_DEVICE_COUNT == 25u, "DEVICE_COUNT syscall number changed");
static_assert(XYRIS_SYS_NET_SOCKET == 27u, "NET_SOCKET syscall number changed");
static_assert(XYRIS_SYS_SECURITY_IDENTITY == 33u, "SECURITY_IDENTITY syscall number changed");
